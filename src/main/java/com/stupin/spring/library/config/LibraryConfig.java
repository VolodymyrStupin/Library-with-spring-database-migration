package com.stupin.spring.library.config;
...
@ComponentScan(basePackages="com.stupin.spring.library")
...
public class LibraryConfig implements WebMvcConfigurer {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(){
		...
		entityManager.setPackagesToScan("com.stupin.spring.library.entity");
