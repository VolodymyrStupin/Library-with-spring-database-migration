...
public class UserLogsAspect {
	...
	@Pointcut("execution(* com.stupin.spring.library.dao.UserDAOImpl.saveUser(..))")
	public void saveUser() {}
	
	@Pointcut("execution(* com.stupin.spring.library.dao.UserDAOImpl.enableUser(..))")
	public void enableUser() {}
	
	@Pointcut("execution(* com.stupin.spring.library.dao.UserDAOImpl.disableUser(..))")
	public void disableUser() {}
	
	@Pointcut("execution(* com.stupin.spring.library.dao.UserDAOImpl.updateUser(..))")
